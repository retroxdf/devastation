...
void Enchant(Player* player, Creature* creature, Item* item, uint32 enchantid)
{
    ...
    switch (enchantid)
    {
        ...
        case ENCHANT_WEP_MASSACRE:
            ...
            {
				ChatHandler(player->GetSession()).PSendSysMessage("Esta no es un arma de 2M");
                return;
            }
            break;
        ...
        case ENCHANT_SHIELD_TITANIUM_SPIKE:
            ...
            {
                ChatHandler(player->GetSession()).PSendSysMessage("That isn't a shield");
                return;
            }
            break;
        ...
        case ENCHANT_RANGED_SUN_SCOPE:
            ...
            {
				ChatHandler(player->GetSession()).PSendSysMessage("That isn't a ranged weapon");
                return;
            }
            break;
        default:
    ...
    char* message;
    player->GetSession()->SendNotification("|cff0000FF%s |cffFF0000Item Encantado!", item->GetTemplate()->Name1.c_str());
}
...
class npc_enchantment : public CreatureScript
{
    public:
        ...
        void ShowMainMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_ShortBlade_02:24|t|r[Encantar Arma]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_Staff_109:24|t|r[Encantar Arma 2M]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
			player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Weapon_ShortBlade_02:24|t|r[Encantar Arma a Distancia]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Ability_Warrior_ShieldWall:24|t|r[Encantar Escudo]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Head_Gnome_01:24|t|r[Encantar Casco]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_SHOULDER_97:24|t|r[Encantar Hombros]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\Item_icecrowncloak:24|t|r[Encantar Capa]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_ClothChest:24|t|r[Encantar Pecho]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_MailBracer:24|t|r[Encantar Muneca]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_PlateGloves:24|t|r[Encantar Guantes]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Belt_28:24|t|r[Encantar Cintura Ebilla Eterna]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_ClothPants:24|t|r[Encantar Piernas]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\INV_Misc_Desecrated_LeatherBoots:24|t|r[Encantar Botas]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
            if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 450)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Encantar Anillos", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
