...
public:
	...
	{
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface/ICONS/Spell_Arcane_StudentOfMagic:30|t Aprender Spells!", GOSSIP_SENDER_MAIN, 1);
		player->SEND_GOSSIP_MENU(80001, creature->GetGUID());
		return true;
	}
