...
public:
        ...
        void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
                ...
                m_creature->MonsterWhisper("Tu no eres cazador!", player->GetGUID());
                        return;
                }
 
                if(player->GetPet()) {
                        m_creature->MonsterWhisper("Primero debes retirar tu pet!", player->GetGUID());
 ...
 */
                ...
                player->PlayerTalkClass->SendCloseGossip();
                m_creature->MonsterWhisper("Pet adquirida exitosamente!", player->GetGUID());
        }
        ...
        bool OnGossipHello(Player *player, Creature * m_creature)
        {
                ...
                player->ADD_GOSSIP_ITEM(3, "Consigue una nueva mascota", GOSSIP_SENDER_MAIN, 30);
                if (player->CanTameExoticPets())
                {
                        player->ADD_GOSSIP_ITEM(7, "Obtenga una nueva mascota exótica.", GOSSIP_SENDER_MAIN, 50);
                }
            player->ADD_GOSSIP_ITEM(2, "Visita el establo", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_STABLEPET);
                        player->ADD_GOSSIP_ITEM(1, "Alimentos para mi mascota", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_VENDOR);
                        player->ADD_GOSSIP_ITEM(4, "No importa", GOSSIP_SENDER_MAIN, 150);
        ...
        bool OnGossipSelect(Player *player, Creature * m_creature, uint32 sender, uint32 action)
        {
                ...
                case 30:
                        player->ADD_GOSSIP_ITEM(4, "<- Regresar al menu", GOSSIP_SENDER_MAIN, 100);
                        player->ADD_GOSSIP_ITEM(4, "Pagina siguiente ->", GOSSIP_SENDER_MAIN, 31);
                        player->ADD_GOSSIP_ITEM(6, "Murcielago.", GOSSIP_SENDER_MAIN, 18);
                        player->ADD_GOSSIP_ITEM(6, "Oso.", GOSSIP_SENDER_MAIN, 1);
                        player->ADD_GOSSIP_ITEM(6, "Jabali.", GOSSIP_SENDER_MAIN, 2);
                        player->ADD_GOSSIP_ITEM(6, "Gato.", GOSSIP_SENDER_MAIN, 4);
                        player->ADD_GOSSIP_ITEM(6, "Pajaro Carroñero.", GOSSIP_SENDER_MAIN, 5);
                        player->ADD_GOSSIP_ITEM(6, "Cangrejo.", GOSSIP_SENDER_MAIN, 6);
                ...
                case 31:  
                        player->ADD_GOSSIP_ITEM(4, "<- Regresar al menu", GOSSIP_SENDER_MAIN, 30);
                        ...
                        player->ADD_GOSSIP_ITEM(6, "Araña.", GOSSIP_SENDER_MAIN, 16);
                        player->ADD_GOSSIP_ITEM(6, "Serpiente.", GOSSIP_SENDER_MAIN, 21);  
                        player->ADD_GOSSIP_ITEM(6, "Tortuga.", GOSSIP_SENDER_MAIN, 15);
                        player->ADD_GOSSIP_ITEM(6, "Abeja.", GOSSIP_SENDER_MAIN, 93);
                        player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                        break;
